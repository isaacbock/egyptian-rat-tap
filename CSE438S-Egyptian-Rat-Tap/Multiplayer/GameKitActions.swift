//
//  GameKitActions.swift
//  CSE438S-Egyptian-Rat-Tap
//
//  Created by Katie Lund on 11/23/20.
//  Copyright © 2020 Egyptian Rat Tap. All rights reserved.
//  CITATION: https://medium.com/academy-eldoradocps/gamekit-real-time-multiplayer-tutorial-3bf6b3a53594

import Foundation
import GameKit

protocol GameKitActionsDelegate: class {
...
final class GameKitActions: NSObject, GKLocalPlayerListener {
...
extension GameKitActions: GKMatchmakerViewControllerDelegate {
